...
logger = logging.getLogger('tencent_asr')
    ...
    def start(self):
        ...
        def on_close(ws, close_status_code, close_msg):
            ...
            if close_status_code or close_msg:
                logger.error("websocket close error code %d, msg: %s" % (close_status_code, close_msg))
        ...
        self.ws = websocket.WebSocketApp(requrl, None, on_open=on_open,
